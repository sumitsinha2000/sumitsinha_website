...
const {
  facebook, github, instagram, linkedin, youtube
} = Config.social;

const DomContent = () => (
  <aside>
   
    <div className={`${style.profileAvatar} centerAlign`}/>
    {/*<div className={`${style.logo} centerAlign`}/>*/}
   <div className={`${style.name} centerAlign`}>
      ...
      <div className={`${style.badge} ${style.badgeGray}`}>Pencil &amp; Digital Artist</div>
